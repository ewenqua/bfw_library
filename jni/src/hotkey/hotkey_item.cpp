...
static hotkey::hotkey_item ANDROID_HOTKEY_ZOOM_IN("zoomin");
static hotkey::hotkey_item ANDROID_HOTKEY_ZOOM_OUT("zoomout");
static hotkey::hotkey_item ANDROID_HOTKEY_ZOOM_DEFAULT("zoomdefault");
static hotkey::hotkey_item ANDROID_HOTKEY_CYCLE_BACK_UNITS("cycleback");
static hotkey::hotkey_item ANDROID_HOTKEY_CYCLE_UNITS("cycle");
static hotkey::hotkey_item ANDROID_HOTKEY_END_UNIT_TURN("endunitturn");
static hotkey::hotkey_item ANDROID_HOTKEY_UNDO("undo");
static hotkey::hotkey_item ANDROID_HOTKEY_REDO("redo");
static hotkey::hotkey_item ANDROID_HOTKEY_SHOW_ENEMY_MOVES("showenemymoves");
static hotkey::hotkey_item ANDROID_HOTKEY_BEST_ENEMY_MOVES("bestenemymoves");
static hotkey::hotkey_item ANDROID_HOTKEY_UPDATE_SHROUD("updateshroud");
static hotkey::hotkey_item ANDROID_HOTKEY_RECRUIT("recruit");
static hotkey::hotkey_item ANDROID_HOTKEY_REPEAT_RECRUIT("repeatrecruit");
static hotkey::hotkey_item ANDROID_HOTKEY_RECALL("recall");
static hotkey::hotkey_item ANDROID_HOTKEY_WB_DELETE_ACTION("wbdeleteaction");
static hotkey::hotkey_item ANDROID_HOTKEY_WB_EXECUTE_ACTION("wbexecuteaction");
static hotkey::hotkey_item ANDROID_HOTKEY_SAVE_GAME("save");
static hotkey::hotkey_item ANDROID_HOTKEY_LOAD_GAME("load");
static hotkey::hotkey_item ANDROID_HOTKEY_SPEAK_ALL("speaktoall");
static hotkey::hotkey_item ANDROID_HOTKEY_SPEAK_ALLY("speaktoally");
static hotkey::hotkey_item ANDROID_HOTKEY_ENDTURN("endturn");
#endif
...
const hotkey_item& get_hotkey(const SDL_KeyboardEvent& event)
{
	...
	case SDLK_CUSTOM1:
		return ANDROID_HOTKEY_ZOOM_IN;
	case SDLK_CUSTOM2:
		return ANDROID_HOTKEY_ZOOM_OUT;
	case SDLK_CUSTOM3:
		return ANDROID_HOTKEY_ZOOM_DEFAULT;
	case SDLK_CUSTOM4:
		return ANDROID_HOTKEY_CYCLE_BACK_UNITS;
	case SDLK_CUSTOM5:
		return ANDROID_HOTKEY_CYCLE_UNITS;
	case SDLK_CUSTOM6:
		return ANDROID_HOTKEY_END_UNIT_TURN;
	case SDLK_CUSTOM7:
		return ANDROID_HOTKEY_UNDO;
	case SDLK_CUSTOM8:
		return ANDROID_HOTKEY_REDO;
	case SDLK_CUSTOM9:
		return ANDROID_HOTKEY_SHOW_ENEMY_MOVES;
	case SDLK_CUSTOM10:
		return ANDROID_HOTKEY_BEST_ENEMY_MOVES;
	case SDLK_CUSTOM11:
		return ANDROID_HOTKEY_UPDATE_SHROUD;
	case SDLK_CUSTOM12:
		return ANDROID_HOTKEY_RECRUIT;
	case SDLK_CUSTOM13:
		return ANDROID_HOTKEY_REPEAT_RECRUIT;
	case SDLK_CUSTOM14:
		return ANDROID_HOTKEY_RECALL;
	case SDLK_CUSTOM15:
		return ANDROID_HOTKEY_WB_DELETE_ACTION;
	case SDLK_CUSTOM16:
		return ANDROID_HOTKEY_WB_EXECUTE_ACTION;
	case SDLK_CUSTOM17:
		return ANDROID_HOTKEY_SAVE_GAME;
	case SDLK_CUSTOM18:
		return ANDROID_HOTKEY_LOAD_GAME;
	case SDLK_CUSTOM19:
		return ANDROID_HOTKEY_SPEAK_ALL;
	case SDLK_CUSTOM20:
		return ANDROID_HOTKEY_SPEAK_ALLY;
	case SDLK_CUSTOM21:
		return ANDROID_HOTKEY_ENDTURN;
	default:
		break;
	} 
#endif
