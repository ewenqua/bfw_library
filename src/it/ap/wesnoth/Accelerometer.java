...
public class Accelerometer implements SensorEventListener {
	...
	public Accelerometer(Activity context)
	{
	...
	public synchronized void stop()
	{
		if( _manager != null )
		{
			Logger.log("libSDL: stopping accelerometer/gyroscope");
	...
	public synchronized void start()
	{
		...
		{
			Logger.log("libSDL: starting accelerometer");
		...
		{
			Logger.log("libSDL: starting gyroscope");
	...
	{
		// TODO: check reverse
		if( Globals.screenOrientation.isLandscape() )
